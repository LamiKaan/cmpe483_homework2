...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var ethers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ethers */ "./node_modules/ethers/lib.esm/providers/provider-browser.js");
...
var diamondAddress = "0xA51c1fc2f0D1a1b8494Ed1FE312d7C3a78Ed91C0";
var lotteryTokenAddress = "0x0165878A594ca255338adfa4d48449f69242Eb8F";

// INITIALIZATION FUNCTIONS
function createSignersManually() {
  return _createSignersManually.apply(this, arguments);
}
function _createSignersManually() {
  _createSignersManually = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
...
function loadContractData() {
  return _loadContractData.apply(this, arguments);
}
function _loadContractData() {
  _loadContractData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response, contractData;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return fetch("/contractData.json");
        case 2:
          response = _context2.sent;
          _context2.next = 5;
          return response.json();
        case 5:
          contractData = _context2.sent;
          console.log("Contract Data (ABIs and bytecodes) has been loaded.");
          return _context2.abrupt("return", contractData);
        case 8:
        case "end":
...
function _connectMetaMask() {
  _connectMetaMask = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var contractData, abis, bytecodes, approvedAccounts, _iterator, _step, account, ownershipFacetFactory, userFacetFactory;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 2:
          contractData = _context3.sent;
          abis = contractData.abis;
          bytecodes = contractData.bytecodes;
          if (!window.ethereum) {
            _context3.next = 25;
            break;
          }
          provider = new ethers__WEBPACK_IMPORTED_MODULE_0__.BrowserProvider(window.ethereum);
          _context3.next = 9;
          return provider.send("eth_requestAccounts", []);
        case 9:
          approvedAccounts = _context3.sent;
          console.log("Approved Accounts:");
          _iterator = _createForOfIteratorHelper(approvedAccounts);
          try {
        ...
        case 15:
          ...
          // Set contracts
          diamond = new ethers__WEBPACK_IMPORTED_MODULE_1__.BaseContract(diamondAddress, abis["Diamond"]);
          lotteryToken = new ethers__WEBPACK_IMPORTED_MODULE_1__.BaseContract(lotteryTokenAddress, abis["LotteryToken"]);
          ownershipFacetFactory = new ethers__WEBPACK_IMPORTED_MODULE_2__.ContractFactory(abis["OwnershipFacet"], bytecodes["OwnershipFacet"]);
          ownershipFacet = ownershipFacetFactory.attach(diamondAddress);
          userFacetFactory = new ethers__WEBPACK_IMPORTED_MODULE_2__.ContractFactory(abis["UserFacet"], bytecodes["UserFacet"]);
          userFacet = userFacetFactory.attach(diamondAddress);
          libDiamond = new ethers__WEBPACK_IMPORTED_MODULE_3__.Interface(abis["LibDiamond"]);
          _context3.next = 26;
          break;
        case 25:
...
function _getBlockTimestamp() {
  _getBlockTimestamp = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var latestBlock, timestamp;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          document.getElementById("getBlockTimestampOutput").innerHTML = "<b>Timestamp:</b> ".concat(timestamp);
          _context4.next = 12;
          break;
        case 8:
          _context4.prev = 8;
...
function getCurrentSigner() {
  return _getCurrentSigner.apply(this, arguments);
} // LOTTERY TOKEN DIV FUNCTIONS
function _getCurrentSigner() {
  _getCurrentSigner = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var signerAddress;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 6:
          ...
          document.getElementById("getSignerOutput").innerHTML = "<b>Current Signer:</b> ".concat(signerAddress);
          _context5.next = 14;
          break;
        case 10:
          _context5.prev = 10;
...
function _buyTokens() {
  _buyTokens = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var gweiAmount, tx, receipt;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          gweiAmount = document.getElementById("gweiAmount").value;
          console.log("Gwei Amount: ", gweiAmount);
          console.log("String Gwei Amount: ", gweiAmount.toString());
          _context6.next = 10;
          return lotteryToken.connect(signer).buyTokens(gweiAmount, {
            value: ethers__WEBPACK_IMPORTED_MODULE_4__.parseUnits(gweiAmount.toString(), "gwei")
          });
        case 10:
          tx = _context6.sent;
        ...
        case 19:
          ...
          console.error(_context6.t0.info);
          document.getElementById("buyTokensOutput").innerText = _context6.t0.shortMesssage;
        case 24:
        case "end":
...
function getSignerBalance() {
  return _getSignerBalance.apply(this, arguments);
}
function _getSignerBalance() {
  _getSignerBalance = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
    var balance;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 3:
          ...
          _context7.t0 = lotteryToken.connect(signer);
          _context7.next = 7;
          return signer.getAddress();
        case 7:
          _context7.t1 = _context7.sent;
          _context7.next = 10;
          return _context7.t0.balanceOf.call(_context7.t0, _context7.t1);
        case 10:
          balance = _context7.sent;
          document.getElementById("getSignerBalanceOutput").innerHTML = "<b>Balance:</b> ".concat(balance, " LT");
          _context7.next = 18;
          break;
        case 14:
          _context7.prev = 14;
          _context7.t2 = _context7["catch"](0);
          console.error(_context7.t2.info);
          document.getElementById("getSignerBalanceOutput").innerText = _context7.t2.shortMesssage;
        case 18:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 3:
          ...
          _context8.next = 7;
          return lotteryToken.connect(signer).balanceOf(accountAddress);
        case 7:
          balance = _context8.sent;
          document.getElementById("getAccountBalanceOutput").innerHTML = "<b>Balance:</b> ".concat(balance, " LT");
          _context8.next = 15;
          break;
        case 11:
          _context8.prev = 11;
          _context8.t0 = _context8["catch"](0);
          console.error(_context8.t0.info);
          document.getElementById("getAccountBalanceOutput").innerText = _context8.t0.shortMesssage;
        case 15:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        ...
        case 3:
          ...
          minPercentage = document.getElementById("minPercentage").value;
